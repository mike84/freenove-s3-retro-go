...
def build_app(app, device_type, with_profiling=False, no_networking=False, is_release=False):
    ...
    if os.getenv("CMAKE_MAKE_PROGRAM"):
        args.append(f"-DCMAKE_MAKE_PROGRAM={os.getenv('CMAKE_MAKE_PROGRAM')}")
    if os.getenv("CMAKE_C_COMPILER"):
        args.append(f"-DCMAKE_C_COMPILER={os.getenv('CMAKE_C_COMPILER')}")
    if os.getenv("CMAKE_CXX_COMPILER"):
        args.append(f"-DCMAKE_CXX_COMPILER={os.getenv('CMAKE_CXX_COMPILER')}")
    if os.getenv("CMAKE_ASM_COMPILER"):
        args.append(f"-DCMAKE_ASM_COMPILER={os.getenv('CMAKE_ASM_COMPILER')}")
